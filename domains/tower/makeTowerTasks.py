...
def parseTower(s):
    _12 = Program.parse("1x2")
    _21 = Program.parse("2x1")
    ...
    def command(k, environment, continuation):
        ...
        if k == Symbol("1x2") or k == Symbol("t"):
            return Application(_12, continuation)
        if k == Symbol("2x1") or k == Symbol("h2"):
            return Application(_21, continuation)
